...
classes = []
input_dir = "../yolov5/datasets/RDD2022/Norway/train/annotations/xmls/"
output_dir = "../yolov5/datasets/Norway/train/labels/"
image_dir = "../yolov5/datasets/Norway/train/images/"
